...
export const setNewPassword = createAsyncThunk("auth/setNewPassword",
    async (formData) => {
        ...
        try {
            ...
            const {data} = await axios.put(`${BASE_URL}/auth/set-password?email=${formData.email}&newPassword=${formData.newPassword}`
                , {}
            );
            console.log("chenged password ", data);
            return data;
        }
        catch (error) {
...
export const forgotPassword = createAsyncThunk("auth/forgotPassword",
    async (email) => {
        ...
        try {
            ...
            const {data} = await axios.put(`${BASE_URL}/auth/forgot-password?email=${email}`
                , {}
            );
            console.log("chenged password ", data);
            return data;
